...
<div class="cont_text">
                        <div class="info">
                            【あなたのネット販売会社】 (以下当ショップ)は、
                            <a href="/Sugukuru//about_us.jsp">株式会社Sugukuru</a>(以下サービス提供会社)の提供するショッピングカートASPサービス
                            <a href="/Sugukuru//about_us.jsp">Sugukuru</a>(当サービス)を利用して当ショップを開設するにあたりサービス提供会社の定めた
                            <a href="/Sugukuru//privacy.jsp">プライバシー・ポリシー</a>に則った個人情報の取扱いを行います。
                        </div>
                        <dl>
                            <dt>1.個人情報の定義</dt>
                            ...
                            <dd>
                                ...
                                ※ SSLは情報を暗号化することで、盗聴防止やデータの改ざん防止送受信する機能のことで す。SSLを利用する事でより安全に情報を送信する事が可能となります。
                            </dd>
                            <dt>8.お問合せ先</dt>
                            <dd>hogehogefoobar@hoge.com</dd>
